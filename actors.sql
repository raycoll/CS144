...
LOAD DATA LOCAL INFILE "/home/cs144/data/actors.csv" INTO TABLE Actors FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"';

/* Get all actors in "Die Another Day"  */
SELECT * FROM Actors WHERE Movie="Die Another DAY";
